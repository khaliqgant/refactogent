...
describe('SuggestionEngine', () => {
  ...
  describe('generateSuggestions', () => {
    ...
    it('should adjust safety threshold based on skill level', async () => {
      ...
      expect(advancedResult.suggestions.length).toBeGreaterThanOrEqual(beginnerResult.suggestions.length);
    });
    ...
    it('should handle low test coverage appropriately', async () => {
      ...
      const coverageRecommendation = result.recommendations.find(rec => 
        rec.includes('test coverage') || rec.includes('coverage')
      );
