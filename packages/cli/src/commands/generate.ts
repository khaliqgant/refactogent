...
import {
  ...
  SampleProjectConfig,
} from '../generators/sample-project-generator.js';
  ...
  async execute(options: GenerateOptions): Promise<CommandResult> {
    ...
    try {
      if (options.suite) {
        ...
        return this.success(`Generated ${generatedPaths.length} sample projects for testing`, [], {
        ...
        return this.success(`Generated sample project: ${config.name}`, [], {
          projectPath,
          config,
        });
      }
